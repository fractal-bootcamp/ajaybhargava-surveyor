...
--> statement-breakpoint
ALTER TABLE "answers" ADD CONSTRAINT "answers_survey_id_subquestion_id_fk" FOREIGN KEY ("survey_id") REFERENCES "public"."subquestion"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
